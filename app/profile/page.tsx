...
export default function UserProfile() {
  ...
  const handleEdit = async (addressUpdate: Address, index:number, addressId: string) => {
    //   const newUser = { ...userInfo, addresses: [...userInfo.addresses] }; // for shallow copy issue
    //   newUser.addresses.splice(index, 1, addressUpdate);
    //   dispatch(updateUserAsync(newUser));
    await dispatch(deleteUserAddress(addressId));
    await dispatch(addUserAddress({ ...addressUpdate, _id: addressId }));
                ...
                {selectedEditIndex === index ? (
                  <form
                    ...
                    onSubmit={handleSubmit((data) => {
                      handleEdit(data, index, address._id);
                      reset();
                    })}
                  >
                    <div className="space-y-12">
